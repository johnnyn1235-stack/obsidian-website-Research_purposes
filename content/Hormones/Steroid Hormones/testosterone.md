...
**Production**
Testosterone production is controlled by a chain of signals in the brain called the hypothalamic-pituitary-testicular axis, Hypothalamus → GnRH → Pituitary → LH → LHCGR → Gs → AC → cAMP → PKA → HSL + StAR ↑ → Cholesterol → Pregnenolone → Progesterone → 17α-Hydroxyprogesterone → Androstenedione → Testosterone (Humans predominantly uses Δ5 pathway)

![[Pasted image 20260820012825.png]]
